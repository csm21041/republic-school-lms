...
declare module '$env/static/private' {
	export const VITE_API_ENVIRONMENT: string;
	export const VITE_API_BASE_URL: string;
	export const VITE_DEV_MODE: string;
	export const VITE_ENABLE_MOCK_API: string;
	export const VITE_ENABLE_ANALYTICS: string;
	export const VITE_ENABLE_CHAT: string;
	export const VITE_ENABLE_NOTIFICATIONS: string;
	export const VITE_SENTRY_DSN: string;
	export const VITE_GOOGLE_ANALYTICS_ID: string;
